...
router.post('/referrals/:id/offer-intro', requireAuth, socialController.offerIntro);
router.get('/intro-offers', requireAuth, socialController.listIntroOffers);
router.post('/intro-offers/:id/accept', requireAuth, socialController.acceptIntro);
router.post('/intro-offers/:id/decline', requireAuth, socialController.declineIntro);
